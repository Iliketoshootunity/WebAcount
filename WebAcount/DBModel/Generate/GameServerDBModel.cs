...
public partial class GameServerDBModel : MFAbstractSQLDBModel<GameServerEntity>
{
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "RunSatus", "IsCommand", "IsNew", "Name", "Ip", "Port", "CreateTime", "UpdateTime" };
            }
            return _ColumnList;
        }
    }
    ...
    protected override SqlParameter[] ValueParas(GameServerEntity entity)
    {
        SqlParameter[] parameters = new SqlParameter[] {
                ...
                new SqlParameter("@RunSatus", entity.RunSatus) { DbType = DbType.Int32 },
        ...
        foreach (DataRow row in table.Rows)
        {
            ...
            switch (colName.ToLower())
            {
                ...
                case "status":
                    ...
                    break;
                case "runsatus":
                    if (!(reader["RunSatus"] is DBNull))
                        entity.RunSatus = Convert.ToInt32(reader["RunSatus"]);
                    break;
                case "iscommand":
