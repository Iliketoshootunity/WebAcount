...
public partial class AccountDBModel : MFAbstractSQLDBModel<AccountEntity>
{
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "UserName", "Pwd", "Mobile", "Mail", "Money", "Channelld", "LastLogOnServerId", "LastLogOnServerName", "LastLogOnServerTime", "LastLogOnRoleId", "LastLogOnRoleName", "LastLogOnRoleJobId", "CreateTime", "UpdateTime", "DeviceIdentifier", "DeviceModel" };
            }
            return _ColumnList;
        }
    }
    ...
    protected override SqlParameter[] ValueParas(AccountEntity entity)
    {
        SqlParameter[] parameters = new SqlParameter[] {
                ...
                new SqlParameter("@Channelld", entity.Channelld) { DbType = DbType.String },
                ...
                new SqlParameter("@LastLogOnRoleName", entity.LastLogOnRoleName) { DbType = DbType.String },
        ...
        foreach (DataRow row in table.Rows)
        {
            ...
            switch (colName.ToLower())
            {
                ...
                case "money":
                    ...
                    break;
                case "channelld":
                    if (!(reader["Channelld"] is DBNull))
                        entity.Channelld = Convert.ToString(reader["Channelld"]);
                    break;
                ...
                case "lastlogonroleid":
                    ...
                    break;
                case "lastlogonrolename":
                    if (!(reader["LastLogOnRoleName"] is DBNull))
                        entity.LastLogOnRoleName = Convert.ToString(reader["LastLogOnRoleName"]);
                    break;
